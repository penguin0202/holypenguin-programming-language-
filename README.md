# holypenguin-programming-language-
A more than bare-bones programming language inspired by c and c#, written in python, without those nasty classes in use

For a long time now, I've wanted to create a programming language, the main reason is that I wanted something to be MINE, or rather, MY OWN CREATION, something I can call "FROM SCRATCH" (and also the fact that every language I've encountered has flaws and I think I know best despite not even reaching an intermediate level of code).
During the summer, along with other projects I've written in python, I've had this compiler project too.
